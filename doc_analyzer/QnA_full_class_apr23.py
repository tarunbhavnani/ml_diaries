...
files=glob.glob(r'C:\Users\ELECTROBOT\Desktop\Desktop_kachra\*.pdf', recursive=True)

#read and digest files

qna= qnatb(model_path=r'C:\Users\ELECTROBOT\Desktop\Bert-qa\model')

_,_,_,_=qna.files_processor_tb(files)

question="who is roger federer married to"
question= "when did he won his first single grand slam title"



responses= qna.get_response_sents( question)
responses= qna.get_response_sents( question, max_length=7)
#responses=[i for i in responses if len(i['sentence'].split())>7]

correct_answer, answer_extracted, _,_= qna.retrieve_answer(question, top=15,max_length=7)
