...
# -*- coding: utf-8 -*-
"""
Created on Tue May  7 11:35:32 2019
...
#see it is much better in loss minimize!! its deeper!!
input_img = Input(shape=(input_size,))
hidden_1 = Dense(hidden_size*2, activation='relu')(input_img)
...
hidden_4 = Dense(hidden_size*2, activation='relu')(hidden_3)
