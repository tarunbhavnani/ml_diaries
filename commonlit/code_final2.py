...
for epoch in range(epochs):
    ...
    if valid_loss < best_valid_loss:
        ...
        torch.save(model.state_dict(), 'final_model/model_saved.pt')
...
test= pd.read_csv(r"C:\Users\ELECTROBOT\Desktop\kaggle\commonlit_readbility\test.csv")
#create test
test['avg_sent_len']= 0
test['dale_words']= 0
test['hard_word']= 0
...
test_loader=torch.utils.data.DataLoader(test_dataset, batch_size=1,drop_last=True, shuffle=False)
