...
def search():
    try:
        ...
        qna_loaded = get_qna_loaded()
        responses = get_search_responses(search_data, qna_loaded)
...
def get_search_responses(search_data, qna_loaded):
    return qna_loaded.get_top_n( search_data, top=10, lm=True)
